    ...
    public partial class FrmTabs : Form
    {
        ...
        public FrmTabs(string file)
        {
            ...
            if (File.Exists(file))
            {
                ...
                for (int i = 0; i < acorda6.Length; i ++)
                {
        ...
        private void FrmTabs_Load(object sender, EventArgs e)
        {
            ...
            {
                var aux = File.ReadAllLines(ProjectFile);
        ...
        private void btnOKBaixo_Click(object sender, EventArgs e)
        {
            ...
            if (txtCorda1Baixo.Text != "")
                corda1[qtdNotas] = txtCorda1Baixo.Text + "A- ";
            else
                corda1[qtdNotas] = "-A- ";

            if (txtCorda2Baixo.Text != "")
                corda2[qtdNotas] = txtCorda2Baixo.Text + "|- ";
            else
                corda2[qtdNotas] = "-|- ";

            if (txtCorda3Baixo.Text != "")
                corda3[qtdNotas] = txtCorda3Baixo.Text + "|- ";
            else
                corda3[qtdNotas] = "-|- ";

            if (txtCorda4Baixo.Text != "")
                corda4[qtdNotas] = txtCorda4Baixo.Text + "|- ";
            else
                corda4[qtdNotas] = "-|- ";

            if (txtCorda5Baixo.Text != "")
                corda5[qtdNotas] = txtCorda5Baixo.Text + "|- ";
            else
                corda5[qtdNotas] = "-|- ";

            if (txtCorda6Baixo.Text != "")
                corda6[qtdNotas] = txtCorda6Baixo.Text + "|- ";
            else
                corda6[qtdNotas] = "-|- ";
        ...
        private void btnOKCima_Click(object sender, EventArgs e)
        {
            ...
            Array.Resize(ref corda5, corda5.Length + 1);
            Array.Resize(ref corda6, corda6.Length + 1);
            if (txtCorda1Cima.Text != "")
                corda1[qtdNotas] = txtCorda1Cima.Text + "|- ";
            else
                corda1[qtdNotas] = "--- ";

            if (txtCorda2Cima.Text != "")
                corda2[qtdNotas] = txtCorda2Cima.Text + "|- ";
            else
                corda2[qtdNotas] = "--- ";

            if (txtCorda3Cima.Text != "")
                corda3[qtdNotas] = txtCorda3Cima.Text + "|- ";
            else
                corda3[qtdNotas] = "--- ";

            if (txtCorda4Cima.Text != "")
                corda4[qtdNotas] = txtCorda4Cima.Text + "|- ";
            else
                corda4[qtdNotas] = "--- ";

            if (txtCorda5Cima.Text != "")
                corda5[qtdNotas] = txtCorda5Cima.Text + "|- ";
            else
                corda5[qtdNotas] = "--- ";

            if (txtCorda6Cima.Text != "")
                corda6[qtdNotas] = txtCorda6Cima.Text + "V- ";
            else
                corda6[qtdNotas] = "-V- ";
